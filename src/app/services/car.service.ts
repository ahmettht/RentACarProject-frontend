...
export class CarService {
  ...
  getCarsSmall(category: string): Observable<SingleResponseModel<CarDetail>> {
    let newPath = this.apiUrl + 'getcarssmall?category=' + category;
    return this.httpClient.get<SingleResponseModel<CarDetail>>(newPath);
  }
  getCarsMedium(category: string): Observable<SingleResponseModel<CarDetail>> {
    let newPath = this.apiUrl + 'getcarsmedium?category=' + category;
    return this.httpClient.get<SingleResponseModel<CarDetail>>(newPath);
  }
  getCarsBig(category: string): Observable<SingleResponseModel<CarDetail>> {
    let newPath = this.apiUrl + 'getcarsbig?category=' + category;
    return this.httpClient.get<SingleResponseModel<CarDetail>>(newPath);
  }
